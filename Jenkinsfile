pipeline {
  ...
  environment {
    ...
    EXT_USER = 'stenzek'
    EXT_REPO = 'duckstation'
    BUILD_VERSION_ARG = 'DUCKSTATION_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-duckstation'
    CONTAINER_NAME = 'duckstation'
    DOCKERHUB_IMAGE = 'linuxserver/duckstation'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/duckstation'
    PR_DOCKERHUB_IMAGE = 'lspipepr/duckstation'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-duckstation/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-duckstation\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-duckstation\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Duckstation\" \
          --label \"org.opencontainers.image.description=[DuckStation](https://duckstation.org/) is a PS1 Emulator aiming for the best accuracy and game support.\" \
